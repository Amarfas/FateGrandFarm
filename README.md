...
First remove all files from the 'Events Farm' folder, and see if Fate/Grand Farm outputs a Farming Plan. If it does, then one of the Event '.csv's is at fault. Try removing Events until you find the one causing the problem. You can try and create a new file from the ['FGO Efficiency'](https://docs.google.com/spreadsheets/d/1CDQYB2Oa3YT1gfD6eT3hqRR7sVshQIQMKB_BOqDzTRU/) google sheet.
