...
class DataFiles:
    ...
    def _interpret_CSVs( self, goals_CSV, material_list_CSV ):
        ...
        with open( goals_CSV, newline = '', encoding = 'Latin1' ) as f:
            ...
            self.mat_index_total = drop_matrix_index
...
class RunCaps():
    ...
    def add_group_info( self, true_name, group, quest_caps, check = False ):
        if (group['Type'] and group['Count'] > 0) or check:
